    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <h2 className='text-4xl font-black text-center text-slate-200'>PRINCIPAL</h2>
                ...
                <ul className="mt-5">
                    ...
                    <li className="text-center">
                        <Link to='/dashboard/actualizar' className={`${urlActual === '/dashboard/actualizar' ? 'text-slate-100 bg-gray-900 px-3 py-2 rounded-md text-center' : 'text-slate-600'} text-xl block mt-2 hover:text-slate-600`}>Actualizar</Link>
                    </li>
                </ul>
